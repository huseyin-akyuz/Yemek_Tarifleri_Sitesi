...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td>&nbsp;</td>
        <td style="margin-left: 40px">
            <asp:Button ID="BtnTarifOner" runat="server" BackColor="#FFFF99" Height="40px" style="font-weight: 700; font-style: italic; margin-left: 50px" Text="Tarif Öner" Width="150px" OnClick="BtnTarifOner_Click" />
        </td>
    </tr>
</table>
</asp:Content>
